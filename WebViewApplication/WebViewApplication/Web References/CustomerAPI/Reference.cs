...
namespace WebViewApplication.CustomerAPI {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="UserControllerSoap", Namespace="http://tempuri.org/")]
    public partial class UserController : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public UserController() {
            this.Url = global::WebViewApplication.Properties.Settings.Default.WebViewApplication_CustomerAPI_UserController;
        ...
        /// <remarks/>
        public void getCustomerAsync(string username, string password) {
            this.getCustomerAsync(username, password, null);
        }
        
        /// <remarks/>
        public void getCustomerAsync(string username, string password, object userState) {
            ...
            this.InvokeAsync("getCustomer", new object[] {
                        username,
                        password}, this.getCustomerOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void addCustomerAsync(string name, string username, string password) {
            this.addCustomerAsync(name, username, password, null);
        }
        
        /// <remarks/>
        public void addCustomerAsync(string name, string username, string password, object userState) {
